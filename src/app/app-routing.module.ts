...
const routes: Routes = [
    ...
    },
    {
        path: "product-view",
        loadChildren: () =>
            import("./pages/product-view/product-view.module").then(
    ...
    },
    {
        path: "payment-done",
        loadChildren: () =>
            import("./pages/payment-done/payment-done.module").then(
                (m) => m.PaymentDonePageModule
            ),
    },
    {
        path: "orders",
    ...
    },
    {
        path: "billing-detail",
        loadChildren: () =>
            import("./pages/billing-detail/billing-detail.module").then(
                (m) => m.BillingDetailPageModule
            ),
    },
    {
        path: "cancel-order",
        loadChildren: () =>
            import("./pages/cancel-order/cancel-order.module").then(
    ...
    },
    {
        path: "manage-address",
        loadChildren: () =>
            import("./pages/manage-address/manage-address.module").then(
    ...
    },
    {
        path: "add-address",
        loadChildren: () =>
            import("./modals/add-address/add-address.module").then(
    ...
    path: 'semi-cart',
    loadChildren: () => import('./pages/semi-cart/semi-cart.module').then( m => m.SemiCartPageModule)
  },
